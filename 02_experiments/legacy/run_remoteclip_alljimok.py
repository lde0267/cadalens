...
from common.paths import chip_dir, EXPERIMENT_RESULTS, JIMOK_TAXONOMY, MODELS  # noqa: E402

DEF_CHIPS = chip_dir("mask")
DEF_OUT = EXPERIMENT_RESULTS / "legacy" / "alljimok_scores.csv"
DEF_TAX = JIMOK_TAXONOMY
CKPT_DIR = MODELS / "remoteclip"
